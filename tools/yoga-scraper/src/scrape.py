...
PRICING_INSTRUCTION = (
    ...
    "Also fill headline numbers: monthly_pass_pln, single_class_pln, trial_price_pln.\n"
...
ABOUT_INSTRUCTION = (
    ...
    "2. **styles**: Yoga/fitness styles offered. map to standard names: "
    "Ashtanga, Vinyasa, Hatha, Iyengar, Kundalini, Yin, Yin/Restorative, Aerial (joga w hamakach), "
    "Hot Yoga, Pregnancy (joga dla ciężarnych), Nidra, Mysore, Power Yoga, Jivamukti, Pilates, "
    "Pilates Reformer, Stretching, Meditation. Include a style if ANY class or mention of it appears.\n"
